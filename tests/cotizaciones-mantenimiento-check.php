...
$checks = [
  ...
  'app defines native quote order actions' => str_contains($app, "AJAX_COTIZACION_ORDER_CONTEXT") && str_contains($app, "AJAX_COTIZACION_ORDER_SAVE"),
  'router maps native quote order actions' => str_contains($router, "ajax_handler_cotizacion_order_context") && str_contains($router, "ajax_handler_cotizacion_order_save"),
  'runtime exposes native quote order actions' => str_contains($dashboard, "'cotizacion_order_context' => self::AJAX_COTIZACION_ORDER_CONTEXT") && str_contains($dashboard, "'cotizacion_order_save' => self::AJAX_COTIZACION_ORDER_SAVE"),
