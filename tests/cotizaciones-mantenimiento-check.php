...
$checks = [
  ...
  'administrative report is not limited to corrective quotes' => str_contains($handler, "if (\$mode === 'create') {\n        \$reportId = \$this->maintenance_quote_ensure_admin_report") && str_contains($handler, 'id_revision_preventiva'),
