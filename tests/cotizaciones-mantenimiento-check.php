...
$checks = [
  ...
  'native quote view renders detailed materials before offers and labor' => is_int($nativeMaterialBudgetPos) && is_int($nativeMaterialOffersPos) && is_int($nativeLaborBudgetPos) && $nativeMaterialBudgetPos < $nativeMaterialOffersPos && $nativeMaterialOffersPos < $nativeLaborBudgetPos && str_contains($dashboard, 'render_cotizacion_materials_budget_rows') && str_contains($dashboard, 'scm-cotizacion-materials-table') && str_contains($adminCss, '.scm-cotizacion-native-material-offers') && str_contains($adminCss, '.scm-cotizacion-materials-table'),
