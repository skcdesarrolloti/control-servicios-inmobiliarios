...
$checks = [
  ...
  'approved quote cards expose add order action' => str_contains($dashboard, '$cotizacionAprobada ?') && str_contains($dashboard, 'data-iframe-title="A&ntilde;adir orden de mantenimiento"') && str_contains($dashboard, 'anadir-orden-de-mantenimiento'),
