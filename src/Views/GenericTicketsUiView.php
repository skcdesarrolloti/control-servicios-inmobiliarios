    ...
    <div class="scm-filter-card card">
      ...
      <form id="scm-form-<?php echo esc_attr($tabKey); ?>" autocomplete="off">
        ...
        <div class="scm-grid">
          ...
          <div class="scm-field"><label for="<?php echo esc_attr($prefix); ?>busqueda">Busqueda</label><input class="input input-bordered input-sm scm-input" id="<?php echo esc_attr($prefix); ?>busqueda" name="<?php echo esc_attr($prefix); ?>busqueda" type="text" value="<?php echo esc_attr((string) ($p['fBusqueda'] ?? '')); ?>"></div>
          <div class="scm-field"><label for="<?php echo esc_attr($prefix); ?>inmueble">Inmueble</label><input class="input input-bordered input-sm scm-input" id="<?php echo esc_attr($prefix); ?>inmueble" name="<?php echo esc_attr($prefix); ?>inmueble" type="text" value="<?php echo esc_attr((string) ($p['fInmueble'] ?? '')); ?>"></div>
          ...
          <div class="scm-field"><label for="<?php echo esc_attr($prefix); ?>fecha_desde">Fecha desde</label><input class="input input-bordered input-sm scm-input" id="<?php echo esc_attr($prefix); ?>fecha_desde" name="<?php echo esc_attr($prefix); ?>fecha_desde" type="date" value="<?php echo esc_attr((string) ($p['fFechaDesde'] ?? '')); ?>"></div>
          <div class="scm-field"><label for="<?php echo esc_attr($prefix); ?>fecha_hasta">Fecha hasta</label><input class="input input-bordered input-sm scm-input" id="<?php echo esc_attr($prefix); ?>fecha_hasta" name="<?php echo esc_attr($prefix); ?>fecha_hasta" type="date" value="<?php echo esc_attr((string) ($p['fFechaHasta'] ?? '')); ?>"></div>
          ...
          <div class="scm-field"><label for="<?php echo esc_attr($prefix); ?>atraso">Atraso ticket</label><select class="select select-bordered select-sm scm-select" id="<?php echo esc_attr($prefix); ?>atraso" name="<?php echo esc_attr($prefix); ?>atraso">
              <option value="">Todos</option>
          ...
          <div class="scm-field"><label for="<?php echo esc_attr($prefix); ?>sin_actualizar">Sin actualizar</label><select class="select select-bordered select-sm scm-select" id="<?php echo esc_attr($prefix); ?>sin_actualizar" name="<?php echo esc_attr($prefix); ?>sin_actualizar">
              <option value="">Todos</option>
