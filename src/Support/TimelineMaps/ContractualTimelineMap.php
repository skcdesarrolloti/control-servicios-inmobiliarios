...
final class ContractualTimelineMap
{
  /**
  ...
  public static function maps(): array
  {
    ...
    return [
      'contractual'                      => $steps,
      'contractual_procesos_juridicos'   => $steps,
      'contractual_solicitud_contractual' => $steps,
      'contractual_solicitud_sp'         => $steps,
      'contractual_retencion_contrato'   => $steps,
      'contractual_otros_servicios'      => $steps,
    ];
  }
}
