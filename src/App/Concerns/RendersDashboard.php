          ...
          <section class="scm-home-calendar" aria-labelledby="scm-home-calendar-title" data-calendar-sections>
            ...
            <div class="scm-calendar-section-panel<?php echo $activeHomeSection === 'scm-home-calendar-section-mine' ? ' active' : ''; ?>" id="scm-home-calendar-section-mine" data-calendar-section-panel>
              <?php echo $this->render_calendario_actividades_panel($config, [
                ...
                'description' => 'Tu agenda mensual se sincroniza automáticamente con el funcionario asociado a tu sesión.',
            ...
            <div class="scm-calendar-section-panel<?php echo $activeHomeSection === 'scm-home-calendar-section-due' ? ' active' : ''; ?>" id="scm-home-calendar-section-due" data-calendar-section-panel>
              <?php echo $this->render_calendario_actividades_panel($config, [
                ...
                'description' => 'Control mensual de tareas administrativas pendientes y vencidas.',
...
<?php
  ...
  private function render_calendario_actividades_panel(array $config, array $options = []): string
  {
    ...
    $totalLabel = trim((string) ($options['total_label'] ?? ''));
    if ($totalLabel === '') {
      $totalLabel = $view === 'pending'
        ? 'vencimientos'
        : (count($presetTypes) === 1
          ? ($presetTypes[0] === 'tarea' ? 'tareas' : ($presetTypes[0] === 'recordatorio' ? 'recordatorios' : 'eventos programados'))
          : 'items programados');
    }
...
?>
    <div class="<?php echo esc_attr($panelClasses); ?>"
      ...
      <div class="scm-status-topic-head scm-calendar-head">
        <div>
          <div class="scm-calendar-title-row">
            <h3<?php echo $titleId !== '' ? ' id="' . esc_attr($titleId) . '"' : ''; ?>><?php echo esc_html($title); ?></h3>
            <span class="scm-status-count"><strong data-scm-calendar-total>0</strong> <?php echo esc_html($totalLabel); ?></span>
          </div>
          ...
          <div class="scm-calendar-layer-filters" data-scm-calendar-layer-filters aria-label="Filtros de calendario">
            ...
            <div class="scm-calendar-layer-group" aria-label="Capas visibles">
              ...
              <label class="scm-calendar-layer-chip scm-calendar-layer-chip--pending">
                <input type="checkbox" name="item_status" value="pending" <?php echo $statusChecked('pending'); ?>>
              ...
              <label class="scm-calendar-layer-chip scm-calendar-layer-chip--done">
                <input type="checkbox" name="item_status" value="completed" <?php echo $statusChecked('completed'); ?>>
