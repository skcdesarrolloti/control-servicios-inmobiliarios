...
final class AuthenticatedActionRouter
{
  ...
  public function __construct(SuCasaControlServiciosInmobiliarios $application)
  {
    ...
    $this->routes = [
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_EXPORT_CASES_EXCEL => 'ajax_handler_export_cases_excel',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_SEND_COTIZACION_MANTENIMIENTO => 'ajax_handler_send_cotizacion_mantenimiento',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_REPAIR_FOLLOWUP_NOTICE => 'ajax_handler_repair_followup_notice',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_PUBLIC_SERVICES_LIQUIDATOR_SEARCH => 'ajax_handler_public_services_liquidator_search',
      SuCasaControlServiciosInmobiliarios::AJAX_PUBLIC_SERVICES_LIQUIDATOR_CALCULATE => 'ajax_handler_public_services_liquidator_calculate',
      SuCasaControlServiciosInmobiliarios::AJAX_PUBLIC_SERVICES_LIQUIDATOR_GENERATE => 'ajax_handler_public_services_liquidator_generate',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_DUE_CALENDAR => 'ajax_handler_admin_due_calendar',
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_DUE_CASE => 'ajax_handler_admin_due_case',
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_DUE_SETTINGS_SAVE => 'ajax_handler_admin_due_settings_save',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_NOTIFICATIONS_STATS => 'ajax_handler_admin_notifications_stats',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_NOTIFICATIONS_PAYMENT_RECEIPTS_IMPORT => 'ajax_handler_admin_notifications_payment_receipts_import',
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_NOTIFICATIONS_QUEUE => 'ajax_handler_admin_notifications_queue',
      SuCasaControlServiciosInmobiliarios::AJAX_ADMIN_NOTIFICATIONS_QUEUE_DELETE => 'ajax_handler_admin_notifications_queue_delete',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_PROPERTY_HISTORY_REPORT => 'ajax_handler_property_history_report',
      ...
      SuCasaControlServiciosInmobiliarios::AJAX_RENT_INCREASE_LETTERS_LIST => 'ajax_handler_rent_increase_letters_list',
      SuCasaControlServiciosInmobiliarios::AJAX_RENT_INCREASE_LETTERS_CREATE => 'ajax_handler_rent_increase_letters_create',
    ];
